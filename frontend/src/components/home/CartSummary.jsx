    ...
    <div className="overflow-hidden rounded-3xl border border-orange-100 bg-white shadow-[0_20px_60px_rgba(132,101,81,0.12)] sticky top-28">
      <div className="bg-linear-to-r from-orange-500 via-orange-500 to-amber-500 px-6 py-5 text-white">
        <div className="flex items-center gap-3">
          ...
          <div>
              <p className="text-sm font-medium uppercase tracking-[0.2em] text-white/80">Quick checkout</p>
              <h2 className="text-2xl font-extrabold leading-tight">Order summary</h2>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <p className="mt-3 text-center text-xs text-gray-400">
          Complete your order in just a few quick steps.
        </p>
      </div>
